...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.VIF_report_before_dir:str = os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_VIF_REPORT_DIR,
                                               training_pipeline.DATA_TRANSFORMATION_REPORT_BEFORE_FILE_NAME)       
        self.VIF_report_after_dir:str = os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_VIF_REPORT_DIR,
                                               training_pipeline.DATA_TRANSFORMATION_REPORT_AFTER_FILE_NAME)
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.model_metrics_file_path:str = os.path.join(self.model_trainer_dir,
                                                        training_pipeline.MODEL_TRAINER_METRICS_DIR_NAME,
